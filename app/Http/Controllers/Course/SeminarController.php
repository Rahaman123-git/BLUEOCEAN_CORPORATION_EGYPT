...
class SeminarController extends Controller
{
    ...
    {
        $courseSeminars = Seminar::orderBy('seminar_date', 'DESC')->get();
        return view('courses.seminars.index', compact('courseSeminars'));
    }
        ...
        if($request->ajax()){
            ...
            try{
                $validator = Validator::make($request->all(), [
                	'seminar_type'                           => 'required|string|in:SEMINAR,WEBINER',
                ...
                Seminar::create([
                    ...
                    'seminar_date'                            => Carbon::createFromFormat('d.m.Y', $request->event_date),
