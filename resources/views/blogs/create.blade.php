              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="blog_type" id="blogtype" class="form-control" data-placeholder="Blog type">
					...
					<option value="PRESS_REALESE">Press Realese</option>
                  </select>
  ...
  <div class="col-md-6">
    <div class="form-group">
      <label class="control-label">
		...
		<input type="text" name="published_date" id="published_date" class="form-control datepicker" placeholder="published date">
