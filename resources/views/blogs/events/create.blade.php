...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="blogeventdetailsform" id="blogeventdetailsform" action="{{ route('blog.events.events.store', $blog->id) }}">
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="event_short_description" id="eventshortdescription" class="form-control" placeholder="Event short description">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="event_details" class="summernote"></div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="event_highlighted_details" class="summernote"></div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="reel_video_title" id="reelvideotitle" class="form-control" placeholder="Reel video title">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="reel_video_url" id="reelvideourl" class="form-control" placeholder="Reel video url">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_1" id="videoblogurl_1" class="form-control" placeholder="Reel video title">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_2" id="videoblogurl_2" class="form-control" placeholder="Reel video title">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_3" id="videoblogurl_3" class="form-control" placeholder="Reel video title">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_4" id="videoblogurl_4" class="form-control" placeholder="Reel video title">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_5" id="videoblogurl_5" class="form-control" placeholder="Reel video title">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_6" id="videoblogurl_6" class="form-control" placeholder="Reel video title">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_7" id="videoblogurl_7" class="form-control" placeholder="Reel video title">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_9" id="videoblogurl_8" class="form-control" placeholder="Reel video title">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_9" id="videoblogurl_9" class="form-control" placeholder="Reel video title">
                  <div id="video_blog_url_9" class="invalid-feedback"></div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="video_blog_url_10" id="videoblogurl_10" class="form-control" placeholder="Reel video title">
