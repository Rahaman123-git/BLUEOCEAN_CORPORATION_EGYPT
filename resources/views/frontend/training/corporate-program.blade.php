...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse flex-wrap">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('training.corporate') }}" class="ms-1 text-sm font-medium text-[#9A9A9A]">Corporate Training</a>
            </div>
          </li>
          <li aria-current="page">
            <div class="flex items-center">
              <span class="px-1 text-[#1E1E1E]">/</span>
              <span class="ms-1 text-sm font-medium text-[#1E1E1E]">Corporate Programs</span>
            </div>
          </li>
        </ol>
      </nav>
  ...
  <section class="page-banner-section">
    <div class="page-banner bg-primary">
      <div class="image-half">
        <img src="{{ asset('assets/frontend/images/course/course-page-banner.png') }}" alt="Banner" />
      </div>
          ...
          <div class="page-banner-wrap">
            <div class="basis-[60%] pr-[10%] hdr-course">
              <h1 class="page-banner-heading">
                Transforming Talent,
                <strong class="block">Driving Success.</strong>
              </h1>
            </div>
            <div class="basis-[40%]">
              <p class="text-white text-base lg:text-lg mb-4">
                Advance Workforce Capabilities with Expert-Led Corporate Training. Designed to address industry-specific challenges, our courses equip professionals with cutting-edge skills, leadership insights, and
                strategic expertise to drive business success.
              </p>
              <a href="javascript:void(0)" class="text-secondary hover:underline text-lg lg:text-2xl">Empowering Professionals, Elevating Businesses</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <ul class="flex flex-wrap text-sm font-medium text-center gap-[2px] ml-5 lg:ml-5 2xl:ml-10"
          ...
          <li role="presentation">
            <button class="inline-block p-4 font-medium" id="Courses-styled-tab"
              ...
              aria-selected="false">Corporate Public Courses</button>
          </li>
          <li role="presentation">
            <button class="inline-block p-4 font-medium" id="training-calendar-styled-tab"
              ...
              aria-controls="training-calendar" aria-selected="false">Corporate Training 
              Calendar</button>
          </li>
        </ul>
      </div>
