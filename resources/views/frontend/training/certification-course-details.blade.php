...
@section('og-title', $course->course_title_en)
@section('og-description', $course->course_meta_details)
@section('og-image', asset('storage/courses/courses/'.$course->course_image)  ?? asset('assets/frontend/images/course/traning-course-banner.png'))

@section('twitter-url', url()->current())
@section('twitter-title', $course->course_title_en)
@section('twitter-description', $course->course_meta_details)
@section('twitter-image', asset('storage/courses/courses/'.$course->course_image) ?? asset('assets/frontend/images/course/traning-course-banner.png'))
