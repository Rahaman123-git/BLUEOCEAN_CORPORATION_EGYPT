        ...
        <div class="flex flex-wrap">
          ...
          <div class="width-sixty  mt-8">
            <div class="header_text boc_top-header">
              <h2><span>Embracing </span>The Future of Work</h2>
              <p class="lg:pr-10">The International Human Resources Conference (IHRC) is a future-focused platform designed to equip HR leaders and teams with the knowledge, tools, and strategies to navigate the evolving world of work.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-wrap mt-4 networking-box ihrc-network">
          <div class="w-full lg:w-5/12">
            <div class="support_content ipse-page">
              ...
              <p class="text-white">IHRC highlights the need for upskilling and reskilling the workforce to meet the demands of tomorrow’s job market. It explores strategies for fostering a culture of continuous learning and development.</p>
            </div>
          </div>
          <div class="w-full lg:w-1/2 lg:pl-6">
            <div class="support_content ipse-page">
              ...
              <p class="text-white">The conference delves into creating a seamless and engaging employee experience, ensuring organizations can attract, retain, and nurture top talent in a competitive environment.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="flex flex-wrap items-center">
            <div class="w-full">
              <div class="leadership_text">
                <h2 class="uppercase text-9xl font-bold mar-bot-ihrc">
                  Leadership <span class="font-light text-2xl lg:text-5xl">and</span><br />
                  Collaboration
                </h2>
              </div>
              ...
              <div class="driving-text pr-0 relative pt-8 flex flex-wrap nofalg-icon">
                <div class="stragity-text mb-7 w-full lg:w-1/2 pr-6">
                  <h3 class="text-blue-text-hdr text-2xl lg:text-3xl mb-3 font-bold">Visionary Leadership</h3>
                  <p class="text-stragity-text text-xl lg:text-2xl">
                    IHRC underscores the importance of visionary leadership in driving organizational success. It brings together global HR thought leaders to share best practices and innovative approaches.
                  </p>
                </div>
                <div class="stragity-text w-full lg:w-1/2">
                  ...
                  <p class="text-stragity-text text-xl lg:text-2xl">The conference encourages collaboration across departments, breaking down silos to create a cohesive and aligned workforce.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="w-full">
            <div class="spacial-day_text relative overflow-hidden">
              <picture>
                ...
                <img src="{{ asset('assets/frontend/images/ihrc-img/mobile-banner-bottom.png') }}" alt="banner image" class="img-fluid d-block w-full" />
              </picture>

              <div class="women_special-text absolute">
                <div class="content_women">
                  <h3 class="text-white text-4xl text-end pt-14">
                    <span class="font-light">Where Vision Meets Action</span><br />
          ...
          <div class="width-sixty">
            <div class="matter-text">
              ...
              <ul class="why-ihrc">
                ...
                <li class="why-matters">Builds capabilities for future-ready HR leadership</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="flex w-full flex-wrap">
        <div class="w-full md:w-1/2">
          <div class="confr-text">
            ...
            <div class="w-modify">
              <p class="red-text">A unique platform to learn, network, and advance your HR career and organization.</p>
              ...
              <p class="mt-4">Join industry experts and peers to gain insights, share knowledge, and drive impactful change in your organization.</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 space-x-5 items-center pt-14">
        <div class="col-span-12">
          ...
          <div class="cxo-event relative">
            <div class="flex flex-col lg:flex-row bg-white text-black relative">
              <div class="basis-[40%]">
                <div class="flex justify-around items-center py-10">
                  <div class="ipscicon"><img src="{{ asset('assets/frontend/images/ihrc-img/ihrc.webp') }}" alt="" width="150" /></div>
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ihrc.dubai.2022') }}" class="btn btn_theme flex w-full">
                Discover IHRC DUBAI 2022 Conference<span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
        </div>
