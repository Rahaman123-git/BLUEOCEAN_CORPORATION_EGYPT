    ...
    <div class="container">
        ...
        <div class="flex flex-col lg:flex-row gap-5 lg:items-center bd-member-details py-5">
            <div class="basis-1/2 flex flex-col gap-5 pl-0 lg:pl-16 2xl:pl-32">              
                <div>
                    <h3 class="text-lg lg:text-2xl text-primary font-semibold">Sourav Ganguly</h3>
                    <h4 class="text-lg lg:text-2xl text-black font-medium">
                        Member of Board, Blueocean Corporation<br />
                        Former President <br />
                ...
                <div class="text-[#454545] text-base lg:text-xl">
                    ...
                    <p>
                        Sourav Ganguly, former captain of the Indian cricket team and ex-President of BCCI, is a
                        legendary leader known for transforming Indian cricket. His leadership on and off the field is
        ...
        <div class="flex flex-col lg:flex-row-reverse bd-member-details gap-5 lg:items-center py-5">
            <div class="basis-1/2 flex flex-col gap-5 pr-0 lg:pr-16 2xl:pr-32">
                <div>
                    <h3 class="text-lg lg:text-2xl text-primary font-semibold">Michael Proffitt</h3>
                    <h4 class="text-lg lg:text-2xl text-black font-medium">
                        Former CEO <br />
                        Dubai Logistics City | Supply Chain & Logistics
                    </h4>
                </div>
                <div class="text-[#454545] text-base lg:text-xl">
                    <h5 class="font-medium"><strong>Expertise:</strong></h5>
                    ...
                    <h5 class="font-medium"><strong>Contributions:</strong></h5>
                    <p>Guides Blue Ocean Corporation in logistics training and consulting, enhancing its strategic
                        expansion in supply chain education.</p>
                    <h5 class="font-medium"><strong>Brief Bio:</strong></h5>
                    <p>
                        With a distinguished career in logistics and supply chain management, Michael Proffitt played a
                        key role in developing Dubai Logistics City and shaping global trade hubs. His deep expertise
                        helps Blue Ocean Corporation align its
                        logistics training with real-world industry needs.
                    </p>
                </div>
                <div>
        ...
        <div class="flex flex-col lg:flex-row gap-5 bd-member-details lg:items-center py-5">
            <div class="basis-1/2 flex flex-col gap-5 pl-0 lg:pl-16 2xl:pl-32">
                <div>
                    <h3 class="text-lg lg:text-2xl text-primary font-semibold">Dr. Sathya Menon</h3>
                    <h4 class="text-lg lg:text-2xl text-black font-medium">
                        Group CEO <br />
                        Blue Ocean Corporation<br />
                        Corporate Training & Business Strategy
                    </h4>
                </div>
                <div class="text-[#454545] text-base lg:text-xl">
                    <h5 class="font-medium"><strong>Expertise:</strong></h5>
                    <p>Supply Chain, Procurement, Strategic Consulting, Corporate Training</p>
                    <h5 class="font-medium"><strong>Contributions:</strong></h5>
                    <p>Drives innovation, expansion, and excellence in professional training and corporate learning.</p>
                    <h5 class="font-medium"><strong>Brief Bio:</strong></h5>
                    <p>
                        A highly accomplished leader in training and consulting, Dr. Sathya Menon has spearheaded Blue
                        Ocean Corporation’s growth as a global force in professional education. With multiple
                        certifications and industry recognitions, he
                        ensures that Blue Ocean remains a leader in supply chain and corporate training.
                    </p>
                </div>
                <div>
            ...
            <div class="basis-1/2 relative">
                <img src="{{ asset('assets/frontend/images/advisory/sathya-menon.png') }}"
                    class="absolute bottom-0 w-[60%] left-4" />
                <img src="{{ asset('assets/frontend/images/advisory/advisory-bg-triangle-right.png') }}"
                    class="w-full" />
            </div>
        ...
        <div class="flex flex-col lg:flex-row-reverse bd-member-details gap-5 lg:items-center py-5">
            <div class="basis-1/2 flex flex-col gap-5 pr-0 lg:pr-16 2xl:pr-32">
                <div>
                    <h3 class="text-lg lg:text-2xl text-primary font-semibold">Abdul Azeez</h3>
                    <h4 class="text-lg lg:text-2xl text-black font-medium">
                        Group Chairman<br />
                        Blue Ocean Corporation | Business Leadership & Vision
                    </h4>
                </div>
                <div class="text-[#454545] text-base lg:text-xl">
                    <h5 class="font-medium"><strong>Expertise:</strong></h5>
                    ...
                    <h5 class="font-medium"><strong>Brief Bio:</strong></h5>
                    <p>
                        As the Chairman, Abdul Azeez has been instrumental in Blue Ocean Corporation’s rise as a leading
                        provider of professional training and consulting. His business acumen and leadership ensure that
                        the company remains at the
                        forefront of industry excellence.
                    </p>
                </div>
                <div>
        ...
        <div class="flex flex-col lg:flex-row gap-5 bd-member-details lg:items-center py-5">
            <div class="basis-1/2 flex flex-col gap-5 pl-0 lg:pl-16 2xl:pl-32">
                <div>
                    <h3 class="text-lg lg:text-2xl text-primary font-semibold">John Ellis</h3>
                    <h4 class="text-lg lg:text-2xl text-black font-medium">
                        Chief Operating Officer <br />
                        Blue Ocean Corporation | Aviation & Business Operations
                    </h4>
                </div>
                <div class="text-[#454545] text-base lg:text-xl">
                    <h5 class="font-medium"><strong>Expertise:</strong></h5>
        ...
        <div class="flex flex-col lg:flex-row-reverse gap-5 bd-member-details  lg:items-center py-5">
            <div class="basis-1/2 flex flex-col gap-5 pr-0 lg:pr-16 2xl:pr-32">
                <div>
                    <h3 class="text-lg lg:text-2xl text-primary font-semibold">VS Ramachandran</h3>
                    <h4 class="text-lg lg:text-2xl text-black font-medium">
            ...
            <div class="advisory-detail flex flex-col lg:flex-row py-10 gap-10 lg:gap-0">
                <div class="basis-[45%]">
                    ...
                    <div class="lg:h-[200px]">
                        <p class="text-2xl lg:text-[34px] font-medium text-[#353535] 2xl:pr-[30%]">Ready to collaborate,
                            inquire, or explore speaking opportunities?</p>
                    </div>
                </div>
                <div class="basis-[55%]">
                    <div class="lg:h-[200px]">
                        <p class="text-2xl lg:text-[34px] font-medium text-[#353535] lg:pl-[15%]">Our Advisory Board
