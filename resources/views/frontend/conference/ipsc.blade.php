...
@section('content')
  <div class="w-full">
    <video class="w-full shadow-lg" width="440px" loop="true" autoplay="true" controls="">
      <source src="{{ asset('assets/frontend/images/ipsc-video/IPSC-Promo-Egypt-2025.mp4') }}" type="video/mp4" />
          ...
          <div class="flex flex-wrap">
            <div class="width-forty mt-8">
              <div class="exprience_icon text-center">
                <img src="{{ asset('assets/frontend/images/ipsc-home/ipsc-logo.svg') }}" alt="Exprience icon" class="img-fluid m-auto" />
              </div>
            </div>
            <div class="width-sixty mt-8">
              <div class="header_text boc_top-header">
                ...
                <p class="lg:pr-10">IPSC is a flagship event organized by Blue Ocean Corporation. It is a premier platform aimed at fostering the development and expansion of the global supply chain community.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap">
          <div class="width-forty">
            <div class="pillor_left text-center ipsc-logo-right">
              <img src="{{ asset('assets/frontend/images/ipsc-home/ipsc-logo-white.svg') }}" alt="Exprience icon" class="img-fluid" />
                  ...
                  <div class="w-full xl:w-1/2">
                    <div class="left_award xl:pr-8">
                      ...
                      <p class="site-text text-white">
                        IPSC is a non-profit initiative designed to drive transformative change across the supply chain and procurement sectors.
                      </p>
                    </div>
                  </div>
        ...
        <div class="flex flex-wrap mt-4 networking-box">
          <div class="md:w-auto relative">
            <div class="support_content support_contentt ipse-page">
              ...
              <p class="text-white"><strong>IPSC</strong> brings together thought leaders, industry experts, and emerging talents from around the world.</p>
            </div>
          </div>
          <div class="w-full lg:w-1/2 lg:pl-6">
            <div class="support_content support_contentt ipse-page">
              <h2 class="text-white"><span>Collaborative </span>Platform</h2>
              <p class="text-white">It serves as a collaborative platform to overcome challenges and enable every segment of the supply chain industry to thrive.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="width-sixty">
              <div class="driving-text ipsc-arrow pr-0 lg:pr-10 relative pt-8">
                <div class="stragity-text mb-7">
                  <h3 class="text-blue-text-hdr text-2xl lg:text-3xl mb-3 font-bold">Thought Leadership</h3>
                  <p class="text-stragity-text text-xl lg:text-2xl">
                    The conference provides a platform for sharing innovative ideas and best practices.
                  </p>
                </div>
                <div class="stragity-text">
                  <h3 class="text-blue-text-hdr text-2xl lg:text-3xl mb-3 font-bold">Industry Transformation</h3>
                  <p class="text-stragity-text text-xl lg:text-2xl"><strong>IPSC</strong> plays a pivotal role in shaping the future of the global supply chain community by addressing key challenges and fostering collaboration.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="w-full">
            <div class="spacial-day_text relative overflow-hidden">
              <picture>
                ...
                <img src="{{ asset('assets/frontend/images/ipsc-home/mobile-banner-bottom.png') }}" alt="banner image" class="img-fluid d-block w-full" />
              </picture>

              <div class="women_special-text absolute ipsc-bule-bg">
                <div class="content_women ipsc-page">
                  <h4 class="text-white">IPSC</h4>
                  <h2 class="text-white">is more than just a conference; it is a movement dedicated to empowering the supply chain and procurement industries to achieve sustainable growth and excellence.</h2>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 space-x-5 items-center pt-14">
        <div class="col-span-12">
          ...
          <div class="cxo-event relative mb-8">
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ipsc.london.2024') }}" class="btn btn_theme flex w-full">
                Discover IPSC LONDON 2024 Conference <span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
          <!--  -->
          ...
          <div class="cxo-event relative mb-8">
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ipsc.riyadh.2024') }}" class="btn btn_theme flex w-full">
                Discover IPSC RIYADH 2024 Conference<span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
          <!--  -->
          <div class="cxo-event relative mb-8">
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ipsc.mumbai.2024') }}" class="btn btn_theme flex w-full">
                Discover IPSC MUMBAI 2024 Conferences <span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
          <!--  -->
          <div class="cxo-event relative mb-8">
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ipsc.riyadh.2016') }}" class="btn btn_theme flex w-full">
                Discover IPSC RIYADH 2016 Conference<span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
          ...
          <div class="cxo-event relative mb-8">
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ipsc.dubai.2021') }}" class="btn btn_theme flex w-full">
                Discover IPSC DUBAI 2021 Conference<span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
          <div class="cxo-event relative mb-8">
            ...
            <div class="event-link">
              <a href="{{ route('conferences.ipsc.abudhabi.2016') }}" class="btn btn_theme flex w-full">
                Discover IPSC ABU DHABI 2016 Conferences <span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt="" /></span>
              </a>
            </div>
          </div>
          <!--  -->
