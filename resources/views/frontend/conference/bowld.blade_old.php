            ...
            <div class="flex flex-wrap">
                <div class="width-forty  mt-8">
                    <div class="exprience_icon text-center">
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/BOWLD-1.svg') }}" alt="Exprience icon"
                ...
                <div class="width-sixty  mt-8">
                    <div class="header_text boc_top-header">
                        ...
                        <p class="lg:pr-10"><strong>Blue Ocean Women Leadership Development (BOWLD) –
                                EmpowHer</strong> is a transformative global initiative dedicated to celebrating
                            the achievements of women and fostering a culture of collaboration, inspiration, and
                            mutual support. This powerful platform is designed to enable women to unlock their
                            full potential and drive meaningful change in their organizations and communities.
                        </p>
                    </div>
                </div>
    ...
    <div class="container mx-auto relative">
        <div class="flex flex-wrap items-center">
            <div class="width-forty">
                <div class="header_text text-right xl:pr-8">
            ...
            <div class="flex flex-wrap">
                <div class="width-forty">
                    <div class="pillor_left text-center">
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/BOWLD-white.png') }}" alt="Exprience icon"
                            class="img-fluid ">
                        <div class="text-center lg:text-right">
                            <h2 class="text-white bowld-tagline">
                                <span>Blue <br>Ocean Women</span> Leadership Development
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-wrap mt-4 networking-box">
                <div class="w-full lg:w-5/12 lg:w-1/2  relative">
                    <div class="support_content ipse-page">
                        ...
                        <p class="text-white"><strong>BOWLD  brings together women from diverse industries and backgrounds, building a worldwide network grounded in support, collaboration, and shared success.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap">
                    <div class="w-full sm:w-1/2">
                        <div class="leadership_content">
                            ...
                            <p><strong>EmpowHer</strong> offers tailored programs and workshops to help women
                                develop critical leadership skills, from strategic thinking to effective
                                communication.</p>
                        </div>
                    </div>
                    <div class="w-full sm:w-1/2">
                        <div class="leadership_content">
                            ...
                            <p>The initiative focuses on empowering women to take on leadership roles with
                    ...
                    <div class="spacial-day_text relative bowld-margin">
                        <picture>
                            <source media="(min-width:770px)"
                                srcset="{{ asset('assets/frontend/images/con-bowld-img/spaecialday_img.png') }}">
                            <img src="{{ asset('/images/con-bowld-img/spaecialday_img-mobile.png') }}" alt="banner image"
            ...
            <div class="flex flex-wrap">
                ...
                <div class="width-sixty">
                    <div class="why-matter-content gap-text ">
                        <p>
                            <strong>Redefining Leadership:</strong> BOWLD is more than a platform, it's a global movement to reshape leadership through the advancement of women.
                        </p>
                        <p>
                         <strong> Bridging the Gender Gap: </strong>Offers tools, resources, and support to address ongoing challenges in gender equality.

                        </p>
                        <p>
                           <strong> Fostering Global Community:</strong> Connects women across borders to share experiences, support one another, and grow together.
                        </p>
                           <p>
                           <strong> Empowering with Purpose:</strong>Encourages women to lead with confidence, authenticity, and resilience.
                        </p>
                           <p>
                           <strong>Driving Change:</strong> Impacts individuals, organizations, and society through inclusive leadership development.
                        </p>
                           <p>
                           <strong>Championing Diversity: </strong> Promotes the urgent need for diverse perspectives in leadership roles worldwide.
