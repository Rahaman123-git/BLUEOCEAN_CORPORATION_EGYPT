          ...
          <div class="col-span-5 flex lg:justify-end align-bottom">
            <div class="content-right">
              ...
              <div class=" mt-16 text-left lg:text-right">
                <h2 class="text-white font-bold uppercase"><span class="font-semibold ">
                    Convergence of the
                  </span>
                  <br>C-Suites
                </h2>
          ...
          <div class="col-span-7 lg:pl-6 pl-0">
            ...
            <div class="mission-points flex flex-wrap">
              <div class="text-boxp text-white w-full md:w-1/2 p-0 lg:pr-8 my-5 md:mb-0 text-left md:text-left">
                ...
                <p>To foster innovation and excellence in leadership by creating a collaborative environment for
                  industry leaders to share knowledge and strategies</p>
              </div>
              <div class="text-boxp text-white w-full md:w-1/2 p-0 lg:pr-8 my-5 md:mb-0 text-left md:text-left">
                <h3>Vision</h3>
                <p>To be a beacon of enlightenment for executives, empowering them to navigate evolving market dynamics
                  and achieve organizational success.</p>
              </div>
            </div>
...
<section class="focusd-area overflow-hidden">
    ...
    <div class="container m-auto">
      <div class="grid grid-cols-1">
        ...
        <divh2 class="text-blue-text-hdr font-bold">
            Focus Areas
          </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 mt-8 space-x-5">
          ...
          <div class="col-span-7 flex lg:justify-start justify-center margin-leftnone">
            <div class="focus-center relative z-10 text-center lg:text-right">
              ...
              <h3 class="text-white text-2xl lg:text-5xl font-bold pr-0 lg:pr-14 shift-left">Digital 
</h3>
           ...
           <div class="driving-text pr-0 lg:pr-10  relative pt-8">
            <div class="stragity-text mb-7">
             ...
             <p class="text-stragity-text  text-xl lg:text-2xl">
              Engage with like-minded leaders to build valuable professional relationships.</p>
            </div>
              ...
              <div class="col-span-5 flex justify-start">
                ...
                <div class="col-span-7 flex justify-end items-start">
                 <div class="blue-box-content text-white">
                    <h4>The CXO <br>Roundtable 
                        <br>is designed for:</h4>
                        <h4 class="mt-8">C-suite executives 
                            <span>CEOs, CFOs, COOs, CIOs</span>  etc.
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 space-x-5 items-center pt-14">
            <div class="col-span-12">
              ...
              <div class="cxo-event relative">
                ...
                <div class="event-link ">
                    <a href="{{ route('conferences.cxo.dubai.2024') }}" class="btn btn_theme flex w-full">Discover More <span class="ml-2"><img src="{{ asset('assets/frontend/images/cxo-image/right-arrow.svg') }}" alt=""></span></a>
                  </div>
            </div>
            </div>
