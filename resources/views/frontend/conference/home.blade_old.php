...
@section('meta-description',
    'Blue Ocean hosts premier conferences: IPSC, IHRC, CXO, BOWLD. Thought leadership meets
    innovation.')
    @push('styles')
            ...
            <div class="container mx-auto px-4">
                <div class="custom-grid">
                    ...
                    <div class=" about-content p-6  mb-6 md:mb-0 ">
                        <div>
                            <div class="flex flex-wrap items-center pt-6">
                                <div class="w-full flex flex-col sm:flex-row flex-wrap aboutsectionHeading">
                                    ...
                                    <div class="exprience_icon text-end pl-9">
                                        <img src="{{ asset('assets/frontend/images/con-bowld-img/exprience_icon.svg') }}"
                                            alt="Exprience icon" class="w-full h-auto" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sectionContent">
                                ...
                                <div class="conference-image">
                                    <img src="{{ asset('assets/frontend/images/newImages/conference-image-sm.png') }}"
                                        alt="triangle image" class="w-full h-auto for phone" />
                                </div>
                        ...
                        <div class="about-btn">
                            <div class="">
                                <a href="https://blueoceancorporation.com/conferences/ipsc-2025"
                                    class="btn primary-btn bg-blue-600 text-white py-3 px-5 mt-3" contenteditable="false"
                                    style="cursor: pointer;">
                                    Register Now <span><img
                    ...
                    <div class=" text-white p-6  rightaboutus">
                        <div class="triangleImage">
                            <img src="{{ asset('assets/frontend/images/newImages/confarence_about.png') }}"
                                alt="triangle image" class="w-full h-auto for desktop" />
                        </div>
                    </div>
            ...
            <div class="flex flex-wrap items-center">
                <div class="lg:w-1/2 flex flex- w-full upcoming-event-ads">
                    ...
                    <div class="relative flex flex-wrap w-full items-center">
                        <img src="{{ asset('assets/frontend/images/all-conference-new/new-event-IPSC-Delhi.png') }}"
                            alt="angle" class="w-full upcoming-event-ad"/>
                        <div class="container upcoming-event-ad-sm">
                            <img src="{{ asset('assets/frontend/images/newImages/upcoming-event-ad-sm.png') }}"
                            alt="angle" class="w-full"/>
                        </div>
                        <div class="new-eventoverlap absolute w-full top-0 h-100 h-full">
                            <div class="flex ">
                                <div class="w-1/2">
                                    <div class="event-link-btn">
                                        <a href="{{ route('conferences.ipsc.2025') }}"
                                            class="btn primary-btn bg-blue-600 text-white py-3 px-5 mt-3">
                                            Register Now <span><img
                    ...
                    <div class="expertish_text py-4">
                        ...
                        <div class="flex flex-wrap lg:flex-nowrap">
                            <div class="w-full mb-6 md:w-1/3 expt-righttt">
                                ...
                                <p class="text-white">Facilitating meaningful interactions that strengthen partnerships and encourage collaboration across industries.
                                </p>
                            </div>
                ...
                <div class="expertish_text">
                    <div class="header_text py-5">
                        ...
                        <p class="mt-4  text-xl ">
                            Our conferences are global platforms for thought leadership, collaboration, and innovation. By
                            bringing together industry leaders, visionaries, and change-makers, we create opportunities for
            ...
            <div class="inovation-custom-lg flex flex-wrap">
                    ...
                    <div class="inovation_logo relative">
                        ...
                        <div class="inovation-hover flex items-center inovation-hover-two">
                            <div class="inv_hov-image">
                                <img src="{{ asset('assets/frontend/images/con-bowld-img/ipsc_hover.svg') }}"
                                    alt="" class="w-full" />
                            </div>
                            <div class="inv_hov-text">
                                <div class="header_text py-3">
                                    <h2 class="text-white"><span class="text-white font-normal">Connecting Global – <br></span> Supply Chain Leaders.</h2>
                                </div>
                                <a href="{{ route('conferences.ipsc') }}"
                                    class="btn btn_theme btn_text success-btn text-white">
                ...
                <div class="hover-image mb-4">
                    <div class="inovation_logo relative gradent-two">
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/IHRC.svg') }}" alt=""
                            class="w-full main-logo" />
                        <div class="inovation-hover flex items-center">
                            <div class="inv_hov-image">
                                <img src="{{ asset('assets/frontend/images/con-bowld-img/IHRC-hover.svg') }}"
                                    alt="" class="w-full" />
                            </div>
                            <div class="inv_hov-text">
                                <div class="header_text py-3">
                                    <h2 class="text-white"><span class="text-white">Connecting  Strategic –</br>
                                        </span>HR Leaders</h2>
                                </div>
                                <a href="{{ route('conferences.ihrc') }}"
                                    class="btn btn_theme btn_text success-btn text-white">
                                    Explore More<span><img
                                            src="{{ asset('assets/frontend/images/icons/arrow-right.svg') }}"
                                            alt="" /></span>
                ...
                <div class="hover-image mb-4">
                    <div class="inovation_logo relative gradent-three">
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/CXO-round table.svg') }}" alt=""
                            class="w-full main-logo" />
                        <div class="inovation-hover flex items-center inovation-hover-three">
                            <div class="inv_hov-image">
                                <img src="{{ asset('assets/frontend/images/con-bowld-img/cxo_white.svg') }}"
                                    alt="" class="w-full" />
                            </div>
                            <div class="inv_hov-text">
                                <div class="header_text py-3">
                                    <h2 class="text-white"><span class="text-white">Connecting Visionary <br>
                                            </span>C-suite Leaders </h2>
                                </div>
                                <a href="{{ route('conferences.cxo') }}"
                                    class="btn btn_theme btn_text success-btn text-white">
                                    Explore More<span><img
                                            src="{{ asset('assets/frontend/images/icons/arrow-right.svg') }}"
                                            alt="" /></span>
                ...
                <div class="hover-image mb-4 bottom-content" >
                    <div class="inovation_logo relative gradent-four">
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/BOWLD-1.svg') }}" alt=""
                            class="main-logo" />
                        <div class="inovation-hover inovation-bottom  flex items-center inovation-hover-four">
                            <div class="inv_hov-image">
                                <img src="{{ asset('assets/frontend/images/con-bowld-img/WD-white.svg') }}"
                                    alt="" class="" />
                            </div>
                            <div class="inv_hov-text">
                                <div class="header_text py-1">
                                    <h2 class="text-white"><span class="text-white">Connecting Influential –<br>
                                        </span>Women Leaders</h2>
                                </div>
                                <a href="{{ route('conferences.bowld') }}"
                                    class="btn btn_theme btn_text success-btn text-white">
                                    Explore More<span><img
                                            src="{{ asset('assets/frontend/images/icons/arrow-right.svg') }}"
                                            alt="" /></span>
                ...
                <div class="">
                    ...
                    @foreach($cards as $card)
                        <div class="static-card shadow p-1 text-center w-[300px]" style="background: {{ $card['bg'] }}">
                            ...
                            <img src="{{ asset('assets/frontend/images/con-bowld-img/' . $card['img']) }}"
                                alt="{{ $card['alt'] }}"
                            ...
                            <h2 class="font-normal text-white mb-2 leading-snug text-[24px]">
                                @php
                                $parts = explode('–', $card['title']);
                                @endphp

                                {{ $parts[0] }}
                                @if(isset($parts[1]))
                                – <span class="font-medium">{{ $parts[1] }}</span>
                                @endif
                            </h2>
            ...
            <div class="signatureevent-slider signatureMovement-custom">
                <div class="slider-item">
                    <div class="silder_img">
                        <div class="TriangleBox">
                            <img src="{{ asset('assets/frontend/images/con-bowld-img/Triangel Graphic.png') }}"
                                alt="" class="graphic-angle triangle-customImage"  />
                        </div>


                        <img src="{{ asset('assets/frontend/images/boc-mumbai.png') }}"
                            class="block w-full slider-twoimage" alt="..." />
                    </div>
                    <div class="triangle-gradient absolute signature_angle-content gradent-confrence">
                        <div class="gradent_content">
                            ...
                            <h3 class="mt-4">International Procurement & Supply Chain Conference</h3>
                            <p class="text-dark mt-3 font-medium leading-1">Empowering supply chain leaders with
                                cutting-edge strategies to drive efficiency, resilience, and sustainability.</p>
                            <ul class="mt-3 list-disc pl-8">
                                <li>Hosted global procurement experts & Fortune 500 leaders</li>
                                <li>Featured innovations in digital supply chain transformation</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="slider-item">
                    <div class="silder_img">
                        <div class="TriangleBox">
                            <img src="{{ asset('assets/frontend/images/con-bowld-img/Triangel Graphic.png') }}"
                                alt="" class="graphic-angle" />
                        </div>
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/sigmature_slide2.png') }}"
                            class="block w-full slider-twoimage" alt="..." />
                    </div>
                    <div class="triangle-gradient absolute signature_angle-content gradent-confrence">
                        <div class="gradent_content">
                            <div class="logoContent">
                                ...
                                <img src="{{ asset('assets/frontend/images/con-bowld-img/CXO-round table.svg') }}"
                                    alt="" />
                            </div>
                            <h3 class="mt-4">
                                CXO Roundtable – <br />
                                Convergence of the C-Suite
                            </h3>
                            <p class="text-dark mt-3 font-medium leading-1">
                                Uniting top executives to navigate challenges,
                                drive innovation, and shape the future of business leadership</p>
                            <ul class="mt-3 list-disc pl-8">
                                <li>Exclusive roundtable discussions with industry leaders</li>
                                <li>Focused on balancing resilience and sustainability in supply chain management</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="slider-item">
                    <div class="silder_img">
                        ...
                        <img src="{{ asset('assets/frontend/images/ihrc-img/ihrc-banner.png') }}"
                            class="block w-full slider-twoimage" alt="..." />
                    </div>
                    <div class="triangle-gradient absolute signature_angle-content gradent-confrence">
                        <div class="gradent_content">
                            <div class="logoContent">
                                ...
                                <img src="{{ asset('assets/frontend/images/ihrc-img/ihrc.webp') }}" alt="" />
                            </div>
                            <h3 class="mt-4">
                            ...
                            <p class="text-dark mt-3 font-medium leading-1">
                                IHRC is a forward-thinking initiative designed to prepare HR leaders and teams for the
                                rapidly evolving "future of work." IHRC serves as a platform to equip HR professionals with
                                the knowledge, tools, and strategies needed to
                ...
                <div class="slider-item">
                    <div class="silder_img">
                        ...
                        <img src="{{ asset('assets/frontend/images/bowld-banner.png') }}"
                            class="block w-full slider-twoimage" alt="..." />
                    </div>
                    <div class="triangle-gradient absolute signature_angle-content gradent-confrence">
                        <div class="gradent_content bowld-gradent">
                            <div class="logoContent">

                                <img src="{{ asset('assets/frontend/images/bowld-event/IPSC-dubai.svg') }}" alt=""
                                     class="mr-auto" />
                            </div>
                            <h3 class="mt-4">
                                Blue Ocean <br />
                            ...
                            <p class="text-dark mt-3 font-medium leading-1">Blue Ocean Women Leadership Development (BOWLD) is an empowering conference held in honor of International Women’s Day. It unites women leaders from diverse fields to inspire, connect, and celebrate achievements while fostering growth and collaboration.</p>
...
$sliders = [
    [
        'triangle_img' => asset('assets/frontend/images/newImages/mobileSignatrueEventTriangle.png'),
        'icon_img'     => asset('assets/frontend/images/con-bowld-img/IPSC2026.svg'),
        'main_img'     => asset('assets/frontend/images/boc-mumbai.png'),
        'title'        => 'International Procurement & Supply Chain Conference',
        'description'  => 'Empowering supply chain leaders with cutting-edge strategies to drive efficiency, resilience, and sustainability.',
        'points'       => [
     ...
     [
        'triangle_img' => asset('assets/frontend/images/newImages/mobileSignatrueEventTriangle.png'),
        'icon_img'     => asset('assets/frontend/images/con-bowld-img/CXO-round table.svg'),
        'main_img'     => asset('assets/frontend/images/sigmature_slide2.png'),
        'title'        => 'CXO Roundtable <br/> Convergence of the C-Suite',
        'description'  => 'Uniting top executives to navigate challenges, drive innovation, and shape the future of business leadership.',
        'points'       => [
     ...
     [
        'triangle_img' => asset('assets/frontend/images/newImages/mobileSignatrueEventTriangle.png'),
        'icon_img'     => asset('assets/frontend/images/ihrc-img/ihrc.webp'),
        'main_img'     => asset('assets/frontend/images/ihrc-img/ihrc-banner.png'),
        'title'        => 'The International <br/>  Human Resources Conference',
        'description'  => ' IHRC is a forward-thinking initiative designed to prepare HR leaders and teams for the
                                rapidly evolving "future of work." IHRC serves as a platform to equip HR professionals with
                                the knowledge, tools, and strategies needed to
                                navigate this dynamic landscape.',
        'points'       => [
     ...
     [
        'triangle_img' => asset('assets/frontend/images/newImages/mobileSignatrueEventTriangle.png'),
        'icon_img'     => asset('assets/frontend/images/bowld-event/IPSC-dubai.svg'),
        'main_img'     => asset('assets/frontend/images/bowld-banner.png'),
        'title'        => ' Blue Ocean <br /> Women Leadership Development',
        'description'  => ' EmpowHer is a transformative global initiative
                                dedicated to celebrating the achievements of women and fostering a culture of collaboration,
                                inspiration, and mutual support.',
        'points'       => [
            'EmpowHer shines a spotlight on the accomplishments of women leaders',
            'By showcasing success stories, the platform inspires the next generation',
        ]
    ],
];
@endphp
...
<div class="slider-item">
    <div class="signatureEvent-image">
        <div class="trigangleImage">
            <img src="{{ $slider['triangle_img'] }}" class="block w-full" alt="Triangle" />
            <div class="icon">
                <img src="{{ $slider['icon_img'] }}" alt="Icon" />
            </div>
        </div>
        <img src="{{ $slider['main_img'] }}" class="block w-full" alt="Main Slide" />
    </div>
    <div class="content-slider">
        <h3 class="mt-4">{!! $slider['title'] !!}</h3>
        <p class="text-dark mt-3 font-medium leading-1">{{ $slider['description'] }}</p>
        <ul class="mt-3 list-disc pl-8">
            ...
            <div class="row flex flex-wrap">
                <div class="expertish_text explore-custom">
                    <div class="explore_box explore_opportunities ">
                        <h4 class="ft-size-24">Explore limitless opportunities with
                            <span class="impect_text ft-size-24">Blue Ocean Corporation</span>
                            where transformation meets
                            innovation.</h4>
                        <div class="mt-2">
                            <a href="#" class="btn btn_theme btn_text success-btn font-bold">
                                View all Conferences<span>
                                    <img
                                        src="{{ asset('assets/frontend/images/consulting/arrow-right-blue.webp') }}"
                                        alt="" /></span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="w-full">
                    <div class="text_hover_box relative overflow-hidden">
                        <div class="img-hover_box">
                            <img src="{{ asset('assets/frontend/images/con-bowld-img/hover-one.jpg') }}"
                                alt="" />
                    ...
                    <div class="benefit_content mt-4 sectionTitleSize">
                        ...
                        <!-- <div class="list-benefit mt-3">
                                                                      ...
                                                                      <div id="benefit-1" class="benefit-box">
                                                                        <p>Exclusive Branding Opportunities Networking Access Thought Leadership Custom
                                                                          Packages Maximize your brand’s
                                                                          visibility and impact through event and site branding and exposure on digital
                                                                          platforms.</p>
                                                                      </div>
                                                                      ...
                                                                      <div id="benefit-4" class="benefit-box">
                                                                        <p>
                                                                          Benefit from customized sponsorship packages that align with your brand’s goals,
                                                                          ensuring maximum impact and
                                                                          targeted engagement.
                                                                        </p>
                                                                      </div>
                                                                    </div> -->
                        <div class="list-benefit befinift-custom mt-3">
                            ...
                            <div id="benefit-1" class="benefit-box">
                                <p>Maximize your brand’s visibility and impact through event and site branding and exposure
                            ...
                            <div id="benefit-4" class="benefit-box">
                                <p>Benefit from customized sponsorship packages that align with your brand’s goals, ensuring
                                    maximum impact and targeted engagement.</p>
                            </div>
                        </div>
  ...
  @endforeach
    ...
    {{-- ======================== End Sponsership Benifit mobile ================  --}}
        ...
        <div class="right_man_angel absolute">
            <img src="{{ asset('assets/frontend/images/con-bowld-img/right_man-angel.png') }}" alt=""
                class="img-fluid" />
                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="ratio ratio-16x9 mt-3 overflow-hidden">
                        <!-- <video autoplay muted loop class="" controls height="" width="">
                                                                        ...
                                                                        <source src="{{ asset('assets/frontend/images/con-bowld-img/video_file.mp4') }}" type="video/mp4"
                                                                            class="object-fit-contain w-full" autoplay>
                                                                        Your browser does not support the video tag.
                                                                    </video> -->
                    </div>
                </div>
    ...
    <div class="videoTrangle-mobile">
           <div class="awardSection">
            ...
            <div class="awards-Text">
                <h4>Precision.<br />Resilience.<br />Visionary.</h4>
            </div>
                ...
                <div class="w-full">
                    <div class="reward_box relative">
                        ...
                        <div class="award_image absolute ">
                            <img src="{{ asset('assets/frontend/images/con-bowld-img/award_image.png') }}" alt=""
                                class="img-fluid hideOnMobile" />
                                <div class="hideOnMobile">
<a href={{ route('conferences.awards') }}
                                class="btn primary-btn bg-blue-600 text-white py-2 px-4 margin-bottom- mt-8 ">
                                Register Now<span><img src="{{ asset('assets/frontend/images/icons/arrow-right.svg') }}"
                                        alt="" /></span>
                            </a>
                                </div>
  ...
  <div class="showOnMobile">
             <a href={{ route('conferences.awards') }}
                                class="btn primary-btn bg-blue-600 text-white py-2 px-4 margin-bottom- mt-4 ">
                                Register Now<span><img src="{{ asset('assets/frontend/images/icons/arrow-right.svg') }}"
                                        alt="" /></span>
                            </a>
           </div>
    ...
    <section class="sponsor p-0 overflow-hidden sponser-padding home-sponser gobalFootPrintSection">
        <div class="container mx-auto">
            <div class="marquee-container">
                <div class="header_text py-5">
                    <h2 class="ft-size-32">
                        <span class="ft-size-32">Global Footprints</span><br>
                        Conferences thats make an Impact.
                    </h2>
                </div>
                <div class="marquee-content">
                    <!--<span class="marquee-item"> <img src="{{ asset('assets/frontend/images/salam-adahar.jpg') }}"
                            alt="" /></span>
                    <span class="marquee-item"> <img src="{{ asset('assets/frontend/images/b4u-logo.jpg') }}"
                            alt="" /></span>
                    <span class="marquee-item"> <img src="{{ asset('assets/frontend/images/platform-logo.jpg') }}"
                            alt="" /></span>
                    <span class="marquee-item"> <img src="{{ asset('assets/frontend/images/salam-adahar.jpg') }}"
                            alt="" /></span>
                    <span class="marquee-item"> <img src="{{ asset('assets/frontend/images/b4u-logo.jpg') }}"
                ...
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-styled-tab"
                            ...
                            aria-selected="false">IPSC</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button
                    ...
                    <div class="differ-slide-custom showOnMobile">
                        <ul class="flex text-sm font-medium text-center my-3" id="default-styled-tab" role="tablist">
                            <li class="flex-1 border-r border-gray-300 last:border-none" role="presentation">
                                <button class="w-full inline-block rounded-t-lg text-gray-700 active"
                                    id="tab-ipsc" data-tabs-target="#content-ipsc" type="button" role="tab"
                                    aria-controls="content-ipsc" aria-selected="true">IPSC</button>
                            </li>
                            <li class="flex-1 border-r border-gray-300 last:border-none" role="presentation">
                                <button class="w-full inline-block rounded-t-lg text-gray-700"
                                    id="tab-ihrc" data-tabs-target="#content-ihrc" type="button" role="tab"
                                    aria-controls="content-ihrc" aria-selected="false">IHRC</button>
                            </li>
                            <li class="flex-1 border-r border-gray-300 last:border-none" role="presentation">
                                <button class="w-full inline-block rounded-t-lg text-gray-700"
                                    id="tab-bowld" data-tabs-target="#content-bowld" type="button" role="tab"
                                    aria-controls="content-bowld" aria-selected="false">BOWLD</button>
                            </li>
                            <li class="flex-1" role="presentation">
                                <button class="w-full inline-block rounded-t-lg text-gray-700"
                                    id="tab-cox" data-tabs-target="#content-cox" type="button" role="tab"
                                    aria-controls="content-cox" aria-selected="false">CXO</button>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="slider-container mt-4">
                                <div class="my-slider" id="slider1">
                                    @foreach($slider1 as $item)
                                        <div class="slide">
                                            <img src="{{ asset('assets/frontend/images/newImages/maps/' . $item['img']) }}"
                                                alt="{{ $item['alt'] }}"
            ...
            <div id="default-styled-tab-content hideOnMobile ">
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-profile" role="tabpanel"
                    ...
                    <div class="map_details relative hideOnMobile">
                        <img src="{{ asset('assets/frontend/images/con-bowld-img/Map.png') }}" alt=""
                            class="w-full h-auto" />
                        <div class="dubai-pin-image">
                            <div class="dubai-image">
                                <img src="{{ asset('assets/frontend/images/con-bowld-img/map_marker.png') }}"
                                    alt="" />
                            </div>
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.dubai.2014') }}"><img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC Dubai (3).png') }}"
                                        alt="" class="w-full h-auto" /></a>
                            </div>
                        </div>
                        <div class="dubai-two-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.abudhabi.2016') }}"> <img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC Dubai (4).png') }}"
                                        alt="" class="w-full h-auto" /></a>
                            </div>
                        </div>
                        <div class="landan-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.london.2024') }}"> <img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC London.png') }}"
                                        alt="" class="w-full h-auto" /></a>
                            </div>
                        </div>
                        <div class="quter-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.qatar.2014') }}"> <img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC Qatar map.png') }}"
                                        alt="" class="w-full h-auto" /></a>
                            </div>
                        </div>
                        <div class="reiyadh-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.riyadh.2016') }}"><img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC Riyadh.png') }}"
                                        alt="" class="w-full h-auto" /></a>
                            </div>
                        </div>
                        <div class="abudhabi-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.abudhabi.2016') }}"> <img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC ABU DHABI.png') }}"
                        ...
                        <div class="mumbai-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.ipsc.mumbai.2024') }}"> <img
                                        src="{{ asset('assets/frontend/images/ipsc-confrances/IPSC Mumbai.png') }}"
                                        alt="" class="w-full h-auto" /></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-dashboard" role="tabpanel"
                    ...
                    <div class="map_details relative">
                        ...
                        <div class="dubai-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="ihrc-dubai-event-2022.html"> <img
                                        src="{{ asset('assets/frontend/images/ihrc-Dubai.png') }}" alt=""
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-settings" role="tabpanel"
                    ...
                    <div class="map_details relative">
                        ...
                        <div class="dubai-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.bowld.event.2025') }}"> <img
                                        src="{{ asset('assets/frontend/images/bowld-location.png') }}" alt=""
                                        class="w-full h-auto" /></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-contacts" role="tabpanel"
                    ...
                    <div class="map_details relative">
                        ...
                        <div class="dubai-pin-image">
                            ...
                            <div class="map-location_view">
                                <a href="{{ route('conferences.cxo.dubai.2024') }}"> <img
                                        src="{{ asset('assets/frontend/images/cxo-location.png') }}" alt=""
                                        class="w-full h-auto" /></a>
                            </div>
                        </div>
                    </div>
   ...
   const sliderSignature = tns({
    ...
    controlsContainer: "#custom-signatureEvent",
        ...
        function startCountdown(targetDate) {
            ...
            updateTimer(); // Immediately update once
            const timerInterval = setInterval(updateTimer, 1000);
        }

        // Set your target date (YYYY, MM (0-based), DD, HH, MM, SS)
        document.addEventListener("DOMContentLoaded", function() {
            const countdownDate = new Date(2025, 7, 8, 0, 0, 0).getTime(); // Example: 1st May 2025
