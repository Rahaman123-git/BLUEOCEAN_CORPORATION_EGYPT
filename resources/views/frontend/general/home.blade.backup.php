    ...
    <div class="container">
      <div class="seminar-rectangle-wrap">
        <div class="seminar-rectangle">
          <p class="rectangle-text">Date: 7th August, 2025 Thursday | At ‘ Le- Meridien’ New Delhi</p>
        </div>
      </div>
    </div>
    <div class="relative">
              ...
              <div class="seminar-list-wrap slider-item">
                <div class="seminar-item">
                  <div class="seminar-wrap">
                    <h5><small>Free Seminar</small></h5>
                    <h6>
                      <small> Supply Chain Risk Professionals</small>
                    </h6>
                    <span class="date-semi">21st June 2025</span>
                  </div>
                </div>
              </div>
              <div class="seminar-list-wrap slider-item">
                ...
                <div class="seminar-wrap">
                  ...
                  <h6>
                    ...
                    <small>Digital Supply Chain Twins</small>
                  </h6>
                  <span class="date-semi">20th June 2025</span>
                </div>
              </div>
            </div>
            <div class="seminar-list-wrap slider-item">
              <div class="seminar-item">
                <div class="seminar-wrap">
                  ...
                  <span class="date-semi">20th Jun’25</span>
                </div>
              </div>
            </div>
          </div>
