...
@section('title', 'Blue Ocean Corporation')
@section('meta-description', 'Blue Ocean Corporation: Empowering businesses across MENA & India with innovative
          solutions in logistics, training, and more.')
@push('styles')
        ...
        <div class="md:w-full lg:w-1/2">
          <div class="header_text bridge-left">
            ...
            <p class="para_three mt-4">
             Our training programs deliver real-world value, having equipped over 500,000 professionals with in-demand skills and internationally recognized certifications. By focusing on global standards, we help individuals stay competitive in todayâ€™s dynamic and fast-evolving environment.
                  ...
                  <div class="testimonial-item bg-[#4BA1BE]">
                    <div class="testimonial-wrap">
                      ...
                      <div class="testimonial-text">
                        The Blue Ocean Staff understood our needs before suggesting solutions and addressed our objectives with tailored training program. These trainings were delivered satisfactorily and met our goals.

                      </div>
                      <div class="testimonial-info">
                        <h3 class="testimonial-name">Transworld</h3>
                ...
                <div class="testimonial-list boc-testimonial">
                  <div class="testimonial-item bg-[#4BA1BE]">
                    <div class="testimonial-wrap">
                      <img src="{{ asset('assets/frontend/images/testimonial-flag.png') }}" class="testimonial-img" />
                      <div class="testimonial-text">
                        I joined the academy for CISCP and CISCM classes. The sessions were a notch above expectations, and the tutorâ€™s insights and inputs have been truly valuable in shaping my career journey. I highly recommend this institution to anyone looking to advance their career and give it a strong boost through certification programs
                ...
                <div class="testimonial-list boc-testimonial">
                  <div class="testimonial-item bg-[#4BA1BE]">
                    <div class="testimonial-wrap">
                      <img src="{{ asset('assets/frontend/images/testimonial-flag.png') }}" class="testimonial-img" />
                      <div class="testimonial-text">
                        A truly enriching experience! I successfully completed the CIPP CIPM certification from Blue Ocean Academy certified from IPSCMI-USA, elevating my procurement and supply chain expertise to the next level. The faculty was exceptional, offering deep industry insights and practical strategies. The entire process was seamless, thanks to Mr. Sameerâ€™s outstanding coordination. If you are looking for a globally recognized certification with top-tier training, Blue Ocean Academy is the place to be!.
...
Itâ€™s truly inspiring to be among so many accomplished individuals, especially the legendary cricketer Sourav Ganguly, whose presence was particularly motivating. This event has not only broadened our perspectives but also contributed meaningfully to enhancing our quality of life.
    ...
    <div class="container">
      <div class="seminar-rectangle-wrap">
        <div class="seminar-rectangle">
          <p class="rectangle-text">Date: 7th August, 2025 Thursday | At â€˜ Le- Meridienâ€™ New Delhi</p>
        </div>
      </div>
    </div>
    <div class="relative">
    ...
    <div class="sponsor p-0 overflow-hidden sponser-padding home-sponser">
        ...
        <div class="container" style="margin-top:70px;">
			<h2 class="font-bold">
              ...
              <p class="mt-4">
We take pride in partnering with visionary businesses that dare to dream big. From startups to industry giants, our collaborations have driven transformative success, turning challenges into opportunities and goals into achievements. Together, weâ€™re shaping the future of business.
              </p>
                    </div>
          ...
          <div class="email_ftr flex flex-col md:flex-row items-center gap-4 h-full">
            ...
            <div class="mail_add">
              <a href="{{ route('general.contact.us') }}" class="flex items-center bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 transition">
                <span class="mr-3"><i class="fa-solid fa-envelope"></i></span> Letâ€™s Connect
              </a>
            </div>
          </div>
        </div>
...
<script>
    ...
    setTimeout(() => {
        ...
        if (navContainer) {
            navContainer.classList.add('success-nav'); // ðŸ‘ˆ Add your class here
        }
    }, 100);
