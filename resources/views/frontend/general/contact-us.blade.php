  ...
  <div class="container">
    ...
    <div class="grid grid-cols-1 lg:gap-8 lg:grid-cols-3">
      ...
      <div class="col-span-2 mb-8 lg:mb-0">
		 ...
		 <iframe aria-label='Download Brochure' frameborder="0" style="height:1000px;width:99%;border:none;" src='https://forms.zohopublic.com/blueoceanmanagementtrainingc10/form/DownloadBrochure1/formperma/9f9IyW6ZYoXgJundLuEYItNnB1DAD7hJobZpiNNY6GY'></iframe>
