...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="courseseminardetailsform" id="courseseminardetailsform" action="{{ route('courses.seminars.store') }}">
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="seminar_type" id="seminartype" class="form-control" data-placeholder="Seminar type">
                    ...
                    <option value="FREE_SEMINAR">Free seminar</option>
                    <option value="PAID_SEMINAR">Paid seminar</option>
                  </select>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="seminar_title_initial" id="seminartitleinitial" class="form-control" placeholder="Seminar title initial">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="seminar_title" id="seminartitle" class="form-control" placeholder="Seminar title">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="seminar_location" id="seminarlocation" class="form-control" placeholder="Seminar location">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="seminar_date" id="seminardate" class="form-control datepicker" placeholder="Seminar date">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="seminar_description" class="summernote"></div>
