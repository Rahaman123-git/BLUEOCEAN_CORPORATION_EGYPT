...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="locationdetailsform" id="locationdetailsform" action="{{ route('website.content.locations.store') }}">
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label">Location name<span class="text-danger">*</span></label>
                  <input type="text" name="location_name" id="locationname" class="form-control" placeholder="Location name">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="location_address" id="locationaddress" class="form-control" placeholder="Location address"></textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="location_landmark" id="locationlandmark" class="form-control" placeholder="Location landmark"></textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="phone_no" id="phoneno" class="form-control" placeholder="Phone no.">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="email_id" id="emailid" class="form-control" placeholder="Email id.">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="google_map_url" id="googlemapurl" class="form-control" placeholder="Google map URL">
                  <div id="google_map_url" class="invalid-feedback"></div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="categoryimage" class="form-label">Location image</label>
