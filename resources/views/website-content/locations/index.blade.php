...
@section('content')
  ...
  <div class="container-fluid"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          <a href="{{ route('website.content.locations.create') }}" class="btn btn-primary">Add new location</a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="table-actions d-flex align-items-center gap-3 fs-6">
                        <a href="{{ route('website.content.locations.edit', $location->id) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                        <a href="javascript:;" class="text-danger locationremove" locationid="{{ $location->id }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                      </div>
                    </td>
                  </tr>
                @endforeach
