...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="conferencecategorydetailsform" id="conferencecategorydetailsform" action="{{ route('conferences.categories.update', $conferenceCategory->id) }}">
          @method('PUT')
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="category_short_title" id="categoryshorttitle" class="form-control" placeholder="Category short title" value="{{ $conferenceCategory->category_short_title }}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="category_title" id="categorytitle" class="form-control" placeholder="Category title" value="{{ $conferenceCategory->category_title }}">
            ...
            <!--/span-->
            <div class="row mb-3">
              <div class="{{ ($conferenceCategory->category_logo) ? 'col-md-5' : 'col-md-6' }}">
                <div class="form-group">
                  <div class="d-flex justify-content-between align-items-center">
              ...
              @if($conferenceCategory->category_logo)
                <div class="col-md-1 mt-35">
                  <div class="form-group">
                    <a href="{{ asset('storage/conferences/category/'.$conferenceCategory->category_logo) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views" target="_blank"><i class="bi bi-cloud-download-fill"></i></a>
                    <input type="hidden" name="existing_category_logo" value="{{ $conferenceCategory->category_logo }}">
                  </div>
                </div>
              @endif
              <div class="{{ ($conferenceCategory->category_banner) ? 'col-md-5' : 'col-md-6' }}">
                <div class="form-group">
                  <div class="d-flex justify-content-between align-items-center">
              ...
              @if($conferenceCategory->category_banner)
                <div class="col-md-1 mt-35">
                  <div class="form-group">
                    <a href="{{ asset('storage/conferences/category/'.$conferenceCategory->category_banner) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views" target="_blank"><i class="bi bi-cloud-download-fill"></i></a>
                    <input type="hidden" name="existing_category_banner" value="{{ $conferenceCategory->category_banner }}">
                  </div>
                </div>
              @endif
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="category_details" class="summernote">{!! $conferenceCategory->category_details !!}</div>
