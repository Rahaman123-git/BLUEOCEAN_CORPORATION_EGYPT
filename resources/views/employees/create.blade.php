...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="employeedetailsform" id="employeedetailsform" action="{{ route('employees.store') }}">
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label">Employee name<span class="text-danger">*</span></label>
                  <input type="text" name="employee_name" id="employeename" class="form-control" placeholder="Employee name">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="employee_email" id="employeeemail" class="form-control" placeholder="Employee email">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="login_username" id="loginusername" class="form-control" placeholder="Login username">
