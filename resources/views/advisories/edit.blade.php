            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="brief_bio" id="brief_bio" class="form-control" placeholder="Brief bio.">{{ $advisory->contributions }}</textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="details_bio" class="summernote">{!! $advisory->details_bio !!}</div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="details_bio_table" class="summernote">{!! $advisory->details_bio_table !!}</div>
