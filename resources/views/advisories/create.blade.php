...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="advisorydetailsform" id="advisorydetailsform" action="{{ route('advisories.store') }}">
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label">Advisor name<span class="text-danger">*</span></label>
                  <input type="text" name="advisor_name" id="advisorname" class="form-control" placeholder="Advisor name">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="contributions" id="contributions" class="form-control" placeholder="Contributions"></textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="brief_bio" id="brief_bio" class="form-control" placeholder="Brief bio."></textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="control-label">Details bio. (in paragraph format)<span class="text-danger">*</span></label>
                  <div name="details_bio" class="summernote"></div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="control-label">Details bio. (in table format)</label>
                  <div name="details_bio_table" class="summernote"></div>
                  <div id="details_bio_table" class="invalid-feedback"></div>
                </div>
              </div>
            </div>
            <!--/span-->
