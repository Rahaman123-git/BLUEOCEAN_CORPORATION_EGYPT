...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-12 mx-auto">
      <hr/>
      <div class="card">
        <form name="consultingdetailsform" id="consultingdetailsform" action="{{ route('consulting.update', $consulting->id) }}">
          @method('PUT')
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-md-6">
                  ...
                  <select name="consulting_company_id" id="consultingcompanyid" class="form-control" data-placeholder="Consulting company">
                    ...
                    @isset($consultingCompanies)
                      @foreach($consultingCompanies as $consultingCompany)
                        <option value="{{ $consultingCompany->id }}" {{ ($consulting->consulting_company_id == $consultingCompany->id) ? 'selected' : '' }}>{{ $consultingCompany->company }}</option>
                      @endforeach
                    @endisset
                  </select>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="consulting_title" id="consultingtitle" class="form-control" placeholder="Consulting title" value="{{ $consulting->consulting_title }}">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="challenge" id="challenge" class="form-control" placeholder="Challenge">{{ $consulting->challenge }}</textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="highlighted_issue" class="summernote">{!! $consulting->highlighted_issue !!}</div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="highlighted_summary" id="highlightedsummary" class="form-control" placeholder="Highlighted Summary">{{ $consulting->highlighted_summary }}</textarea>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="boc_engagement_approach" class="summernote">{!! $consulting->boc_engagement_approach !!}</div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="solutions_designed_delivered" class="summernote">{!! $consulting->solutions_designed_delivered !!}</div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="business_impact_delivered" class="summernote">{!! $consulting->business_impact_delivered !!}</div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="key_learnings_recommendations" class="summernote">{!! $consulting->key_learnings_recommendations !!}</div>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div name="why_boc" class="summernote">{!! $consulting->why_boc !!}</div>
            ...
            <!--/span-->
            <div class="row mb-3">
              <div class="{{ ($consulting->case_study_banner_image) ? 'col-md-5' : 'col-md-6' }}">
                <div class="form-group">
              ...
              @if($consulting->case_study_banner_image)
                <div class="col-md-1 mt-35">
                  <div class="form-group">
                    <a href="{{ asset('storage/consulting/case-studies/'.$consulting->case_study_banner_image) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views" target="_blank"><i class="bi bi-cloud-download-fill"></i></a>
                    <input type="hidden" name="existing_case_study_banner_image" value="{{ $consulting->case_study_banner_image }}">
                  </div>
                </div>
              @endif
              <div class="{{ ($consulting->case_study_image) ? 'col-md-5' : 'col-md-6' }}">
                <div class="form-group">
              ...
              @if($consulting->case_study_image)
                <div class="col-md-1 mt-35">
                  <div class="form-group">
                    <a href="{{ asset('storage/consulting/case-studies/'.$consulting->case_study_image) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views" target="_blank"><i class="bi bi-cloud-download-fill"></i></a>
                    <input type="hidden" name="existing_case_study_image" value="{{ $consulting->case_study_image }}">
                  </div>
                </div>
              @endif
            </div>
            <!--/span-->
            <div class="row mb-3">
              <div class="{{ ($consulting->case_study_thumb_image) ? 'col-md-5' : 'col-md-6' }}">
                <div class="form-group">
              ...
              @if($consulting->case_study_thumb_image)
                <div class="col-md-1 mt-35">
                  <div class="form-group">
                    <a href="{{ asset('storage/consulting/case-studies/'.$consulting->case_study_thumb_image) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views" target="_blank"><i class="bi bi-cloud-download-fill"></i></a>
                    <input type="hidden" name="existing_case_study_thumb_image" value="{{ $consulting->case_study_thumb_image }}">
                  </div>
                </div>
              @endif
              <div class="{{ ($consulting->case_study_file) ? 'col-md-5' : 'col-md-6' }}">
                <div class="form-group">
              ...
              @if($consulting->case_study_file)
                <div class="col-md-1 mt-35">
                  <div class="form-group">
                    <a href="{{ asset('storage/consulting/case-studies/'.$consulting->case_study_file) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views" target="_blank"><i class="bi bi-cloud-download-fill"></i></a>
                    <input type="hidden" name="existing_case_study_file" value="{{ $consulting->case_study_file }}">
                  </div>
                </div>
              @endif
            </div>
