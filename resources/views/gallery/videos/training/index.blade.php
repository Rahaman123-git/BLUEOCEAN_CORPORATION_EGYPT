...
@section('content')
  ...
  <div class="container-fluid"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          <a href="{{ route('galleries.create', [$media, $tag]) }}" class="btn btn-primary">Add new training video</a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Training videos</h6>
    <hr/>
    <div class="card">
      <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="table-actions d-flex align-items-center gap-3 fs-6">
                        ...
                        <a href="javascript:;" class="text-danger galleryremove" galleryid="{{ $gallery->id }}" media="videos" tag="training" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                      </div>
                    </td>
                  </tr>
                @endforeach
