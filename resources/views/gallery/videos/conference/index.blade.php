      ...
      <div class="ps-3 pl-0i">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Event videos</li>
          </ol>
        </nav>
      </div>
      <div class="ms-auto">
        <div class="btn-group">
          <a href="{{ route('galleries.create', [$media, $tag, 'q' => $conference->id]) }}" class="btn btn-primary">Add new event videos</a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Event videos</h6>
    <hr/>
    <div class="card">
      <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="table-actions d-flex align-items-center gap-3 fs-6">
                        ...
                        <a href="{{ route('galleries.edit', [$media, $tag, 'id' => $gallery->id, 'q' => $conference->id]) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                        <a href="javascript:;" class="text-danger galleryremove" galleryid="{{ $gallery->id }}" media="videos" tag="event" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                      </div>
                    </td>
                  </tr>
                @endforeach
