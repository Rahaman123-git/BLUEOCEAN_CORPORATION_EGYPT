    ...
    <div class="ps-3 pl-0i">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('galleries.index', [$media, $tag, 'q' => $conference->id]) }}">Conference photos</a></li>
          <li class="breadcrumb-item active" aria-current="page">Conference photo details</li>
        </ol>
      </nav>
    </div>
  </div>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select id="photoyear" class="form-control" data-placeholder="Photo year" disabled>
                  ...
                  <input type="hidden" name="photo_year" value="{{ $conferenceYear }}">
