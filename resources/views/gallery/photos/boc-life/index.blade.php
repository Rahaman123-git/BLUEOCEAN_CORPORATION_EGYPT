      ...
      <div class="ps-3 pl-0i">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Boc life photos</li>
          </ol>
        </nav>
      </div>
      <div class="ms-auto">
        <div class="btn-group">
          <a href="{{ route('galleries.create', [$media, $tag]) }}" class="btn btn-primary">Add new boc life photo</a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Boc life photos</h6>
    <hr/>
    <div class="card">
      <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="table-actions d-flex align-items-center gap-3 fs-6">
                        ...
                        <a href="javascript:;" class="text-danger galleryremove" galleryid="{{ $gallery->id }}" media="photos" tag="boc-life" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                      </div>
                    </td>
                  </tr>
                @endforeach
