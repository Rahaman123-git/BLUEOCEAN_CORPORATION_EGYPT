...
class TestimonialController extends Controller
{
    ...
    {
        $certificateCourses = Course::select('id', 'course_title_en')->where('course_type', 'CERTIFICATION_TRAINING')->get()->toArray();
        $corporateCourses = Course::select('id', 'course_title_en')->where('course_type', 'CORPORATE_TRAINING')->get()->toArray();
        
        return view('courses.testimonials.create', compact('certificateCourses', 'corporateCourses'));
    }
        ...
        if($request->ajax()){
            ...
            try{
                $validator = Validator::make($request->all(), [
                    ...
                    'testimonial_course_type' => 'required|string|in:CERTIFICATION_TRAINING,CORPORATE_TRAINING',
                ...
                if($request->testimonial_type == 'TEXT_TESTIMONIAL'){
                    ...
                    Testimonial::create([
                        ...
                        'course_type'        => $request->testimonial_course_type,
    ...
    public function edit($id): View
    {
        ...
        return view('courses.testimonials.edit', compact('certificateCourses', 'corporateCourses', 'testimonial'));
    }
